...
using LojaLivro.WebApp.MVC.RefitInternalGenerated;
...
namespace LojaLivro.WebApp.MVC.RefitInternalGenerated
{
...
{
    using global::LojaLivro.WebApp.MVC.Models;
    using global::Refit;
    using global::System;
    ...
    partial class AutoGeneratedICatalogoServiceRefit : ICatalogoServiceRefit
    {
        ...
        /// <inheritdoc />
        Task<IEnumerable<ProdutoViewModel>> ICatalogoServiceRefit.ObterPorData()
        {
            var arguments = new object[] {  };
            var func = requestBuilder.BuildRestResultFuncForMethod("ObterPorData", new Type[] {  });
            return (Task<IEnumerable<ProdutoViewModel>>)func(Client, arguments);
        }
    }
}
